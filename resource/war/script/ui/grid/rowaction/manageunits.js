 ...
 */
fui.provide("fui.ui.grid.manageunits");

fui.require("fui.type");

fui.ui.grid.manageunits = {
	...
	get: function() {
		return new fui.Grid({
			...
			getHeaderButtons: fui.ui.grid.manageunits.getHeaderButtonsList,
            ...
            getUrlFunc: function(gridProperties) {
                return function(){
					var url = fuiConfig.appContext + "/" + fui.ui.manageunits.ACTION_KEY + "/" + fui.ui.manageunits.SEARCH + ".json";
					var params = fui.query.param(fui.ui.manageunits.internal.getSearchParams());
