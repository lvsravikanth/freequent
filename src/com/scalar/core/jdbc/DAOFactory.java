...
public class DAOFactory extends AbstractFactory {
     ...
     * This map uses {@link com.scalar.core.request.Request} objects as the key.
     */
    ...
    /**
     * Returns an object that implements <code>DAO</code> for the given key and <code>Request</code>. The
     ...
     */
    public static <T> T getDAO(Class<T> type, Request request) {
