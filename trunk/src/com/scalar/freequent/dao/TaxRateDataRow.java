 ...
 * Time: 8:12:17 PM
 */
public class TaxRateDataRow {
	protected static final Log logger = LogFactory.getLog(TaxRateDataRow.class);
	...
	private boolean mModPercentage = false;
	public void setPercentage(double x){ mPercentage = x; mModPercentage = true; }
	public boolean modPercentage(){ return mModPercentage; }
