...
/**
 * HttpServletResponse wrapper to capture the output generated by the response view.
 */
public final class SwallowingHttpServletResponse extends HttpServletResponseWrapper implements HttpServletResponse {
	 ...
	 */
	public SwallowingHttpServletResponse(HttpServletResponse response, ServletOutputStream sout) {
		super(response);
