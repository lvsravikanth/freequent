...
public class ErrorTagSupport extends MessageTagSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			pageContext.getOut().write("<div id='frq-error-msg'><script type=\"text/javascript\"> freequent.util.errorinfoutil.showerrors('frq-error-msg' , "+getMessageJSON() +")</script></div>");
